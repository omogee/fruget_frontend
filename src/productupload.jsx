...
class ProductUpload extends Component {
    ...
    componentDidMount=()=>{
    axios.get("https://frugetbackend-production.up.railway.app/details/fetch/details")
...
const formdata = new FormData();
 ...
 // formdata.append("id",id)
  ...
  axios.post(`https://frugetbackend-production.up.railway.app/products/seller/productupload`, formdata, config)
    .then(res => {
        if(res.data.failure){
