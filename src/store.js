...
axios.get(`https://frugetbackend-production.up.railway.app/details/product/display/userdetailsbyuserId?userId=${userId}`,{ headers: {"Authorization" : `Markaranter ${Cookies.get("token")}`,"markaranterTwo":mainToken,"navigation":JSON.stringify(navigation)} })
.then(res => {
...
export const countuserdetails =()=>{
  ...
  axios.get(`https://frugetbackend-production.up.railway.app/customer/count/userdetails`,{ headers: {"Authorization" : `Markaranter ${Cookies.get("token")}`,"markaranterTwo":mainToken,"navigation":JSON.stringify(navigation)} })
...
export const fetchunreadmessages =(data)=>{
  return(dispatch)=>{
    axios.get(`https://frugetbackend-production.up.railway.app/details/messages/unread`,{ headers: {"Authorization" : `Markaranter ${Cookies.get("token")}`,"markaranterTwo":mainToken,"navigation":JSON.stringify(navigation)} })
...
export const viewsender =(data)=>{
  return(dispatch)=>{
    axios.get(`https://frugetbackend-production.up.railway.app/details/product/display/otheruserdetailsbyuserId?userId=${data}`,{ headers: {"Authorization" : `Markaranter ${Cookies.get("token")}`,"markaranterTwo":mainToken,"navigation":JSON.stringify(navigation)} })
...
export const dislikecomment =(data)=>{
  return(dispatch)=>{
    ...
    axios.get(`https://frugetbackend-production.up.railway.app/customer/dislike/comment?commentId=${data.commentId}&productId=${data.productId}`, { headers: {"Authorization" : `Markaranter ${Cookies.get("token")}`,"markaranterTwo":mainToken,"navigation":JSON.stringify(navigation)} })
...
export const likecomment =(data)=>{
  return(dispatch)=>{
    dispatch({type:"catloading"})
    axios.get(`https://frugetbackend-production.up.railway.app/customer/like/comment?commentId=${data.commentId}&productId=${data.productId}`, { headers: {"Authorization" : `Markaranter ${Cookies.get("token")}`,"markaranterTwo":mainToken,"navigation":JSON.stringify(navigation)} })
...
export const ratevendor =(data)=>{
  return(dispatch)=>{
    dispatch({type:"catloading"})
  axios.post(`https://frugetbackend-production.up.railway.app/details/${data.vendor}/rate/vendor`, {data: JSON.stringify(data)},
...
export const rateproduct =(data)=>{
  return(dispatch)=>{
    dispatch({type:"catloading"})
  axios.post(`https://frugetbackend-production.up.railway.app/details/${data.details}/rate/product`, {data: JSON.stringify(data)},
  { headers: {"Authorization" : `Markaranter ${Cookies.get("token")}`,"markaranterTwo":mainToken,"navigation":JSON.stringify(navigation)} })
...
export const services =(data)=>{
  ...
  //  dispatch({type:"loading"})  displaycategorymodal
    axios.get(`https://frugetbackend-production.up.railway.app/customer/fetch/services?lat=${data.lat}&long=${data.long}`)
...
export const changecolor =(data)=>{
  return(dispatch)=>{
    dispatch({type:"loading"})  
    axios.get(`https://frugetbackend-production.up.railway.app/customer/change/bgcolor?color=${data.color}`, { headers: {"Authorization" : `Markaranter ${Cookies.get("token")}`,"markaranterTwo":mainToken,"navigation":JSON.stringify(navigation)} })
...
export const fetchfollowing =(data)=>{
  return(dispatch)=>{
    dispatch({type:"catloading"})
    axios.get(`https://frugetbackend-production.up.railway.app/customer/fetch/following?email=${data}`, { headers: {"Authorization" : `Markaranter ${Cookies.get("token")}`,"markaranterTwo":mainToken,"navigation":JSON.stringify(navigation)} })
...
export const fetchfollowers =(data)=>{
  return(dispatch)=>{
    dispatch({type:"catloading"})
    axios.get(`https://frugetbackend-production.up.railway.app/customer/fetch/followers?email=${data}`, { headers: {"Authorization" : `Markaranter ${Cookies.get("token")}`,"markaranterTwo":mainToken,"navigation":JSON.stringify(navigation)} })
...
export const fetchsavedItembyemail =(data)=>{
  return(dispatch)=>{
    dispatch({type:"loading"})
    axios.get(`https://frugetbackend-production.up.railway.app/customer/fetchbyemail/saveditems?email=${data}`,{ headers: {"Authorization" : `Markaranter ${Cookies.get("token")}`,"markaranterTwo":mainToken,"navigation":JSON.stringify(navigation)} })
...
export const fetchsavedItembyuserId =(data)=>{
  return(dispatch)=>{
    dispatch({type:"loading"})
    axios.get(`https://frugetbackend-production.up.railway.app/customer/fetchbyuserId/saveditems`,{ headers: {"Authorization" : `Markaranter ${Cookies.get("token")}`,"markaranterTwo":mainToken,"navigation":JSON.stringify(navigation)} })
...
export const checksaveItem =()=>{
  return(dispatch)=>{
   // dispatch({type:"loading"})
    dispatch({type:"catloading"})
    axios.get(`https://frugetbackend-production.up.railway.app/customer/check/save`,{ headers: {"Authorization" : `Markaranter ${Cookies.get("token")}`,"markaranterTwo":mainToken,"navigation":JSON.stringify(navigation)} })
...
export const saveItem =(data)=>{
  return(dispatch)=>{
   // dispatch({type:"loading"})
    dispatch({type:"catloading"})
    axios.get(`https://frugetbackend-production.up.railway.app/customer/save?productId=${data.productId}&details=${data.details}`, { headers: {"Authorization" : `Markaranter ${Cookies.get("token")}`,"markaranterTwo":mainToken,"navigation":JSON.stringify(navigation)} })
...
export const unsaveItem =(data)=>{
  return(dispatch)=>{
   // dispatch({type:"loading"})
    dispatch({type:"catloading"})
    axios.get(`https://frugetbackend-production.up.railway.app/customer/unsave?productId=${data}`, { headers: {"Authorization" : `Markaranter ${Cookies.get("token")}`,"markaranterTwo":mainToken,"navigation":JSON.stringify(navigation)} })
...
export const subcat2 =(data)=>{
  return(dispatch)=>{
    axios.get(`https://frugetbackend-production.up.railway.app/products/productsellernumOfRows/${data}/subcat2`)
...
export const subcat3 =(data)=>{
  return(dispatch)=>{
      axios.get(`https://frugetbackend-production.up.railway.app/products/productsellernumOfRows/${data}/subcat3`)
...
export const searcher =(data)=>{
  ...
  axios.post('https://frugetbackend-production.up.railway.app/search/search',{data: JSON.stringify(data)})
 ...
 // dispatch({type: 'loading'})
    axios.post(`https://frugetbackend-production.up.railway.app/search/searchbrand`, {data: JSON.stringify(data)})
    .then(res=> dispatch({type: 'brandsearched', payload: res.data}))
    .then(err => dispatch({type: 'error', payload: err}))

   // dispatch({type: 'loading'})
    axios.post(`https://frugetbackend-production.up.railway.app/search/searchcolour`, {data: JSON.stringify(data)})
    .then(res=> dispatch({type: 'colorsearched', payload: res.data}))
    .then(err => dispatch({type: 'error', payload: err}))

   // dispatch({type: 'loading'})
    axios.post(`https://frugetbackend-production.up.railway.app/search/searchsize`, {data: JSON.stringify(data)})
...
export const followservice =(data)=>{
  return(dispatch)=>{
    dispatch({type:"catloading"})
    axios.get(`https://frugetbackend-production.up.railway.app/details/follow/service?sellerId=${data}`,{ headers: {"Authorization" : `Markaranter ${Cookies.get("token")}`,"markaranterTwo":mainToken,"navigation":JSON.stringify(navigation)} })
...
export const followseller =(data)=>{
  return(dispatch)=>{
    dispatch({type:"catloading"})
    axios.get(`https://frugetbackend-production.up.railway.app/details/follow/seller?sellerId=${data}`,{ headers: {"Authorization" : `Markaranter ${Cookies.get("token")}`,"markaranterTwo":mainToken,"navigation":JSON.stringify(navigation)} })
...
export const viewsellerdetails =(data)=>{
  return(dispatch)=>{
    ...
    axios.get(`https://frugetbackend-production.up.railway.app/details/product/display/sellerdetails?userId=${data}`)
...
export const viewuserdetails =(data)=>{
  return(dispatch)=>{
    dispatch({type:"loading"})   
    axios.get(`https://frugetbackend-production.up.railway.app/details/product/display/userdetails?email=${data}`,{ headers: {"Authorization" : `Markaranter ${Cookies.get("token")}`,"markaranterTwo":mainToken,"navigation":JSON.stringify(navigation)} })
...
export const viewuserdetailsbyuserId =(data)=>{
  return(dispatch)=>{
    dispatch({type:"loading"})   
    axios.get(`https://frugetbackend-production.up.railway.app/details/product/display/userdetailsbyuserId?userId=${data}`,{ headers: {"Authorization" : `Markaranter ${Cookies.get("token")}`,"markaranterTwo":mainToken,"navigation":JSON.stringify(navigation)} })
...
export const viewmyprofiledetails =(data)=>{
  return(dispatch)=>{
    dispatch({type:"loading"})   
    axios.get(`https://frugetbackend-production.up.railway.app/details/product/display/myprofiledetails`,{ headers: {"Authorization" : `Markaranter ${Cookies.get("token")} ${mainToken}`,"markaranterTwo":mainToken,"navigation":JSON.stringify(navigation)} })
...
export const getseller =(data)=>{
  return(dispatch)=>{
    axios.get(`https://frugetbackend-production.up.railway.app/details/product/display/seller?email=${data.email}&details=${data.details}&productId=${data.productId}&user=${data.userId}`,{ headers: {"Authorization" : `Markaranter ${Cookies.get("token")}`,"markaranterTwo":mainToken,"navigation":JSON.stringify(navigation)} })
...
export const getdetails =(data)=>{
 return(dispatch)=>{
   /*
  axios.get(`https://frugetbackend-production.up.railway.app/customer/check/save?productId=${data}`,{ headers: {"Authorization" : `Bearer ${localStorage.getItem("token")}`} })
  .then(res =>  dispatch({type:"checkifsaved",payload:res.data}))
  .catch(err => dispatch({type:"err",payload:err})) 
 */
  dispatch({type:"loading"})
  axios.get(`https://frugetbackend-production.up.railway.app/details/product/${data.productId}`,{ headers: {"Authorization" : `Markaranter ${Cookies.get("token")}`,"markaranterTwo":mainToken,"navigation":JSON.stringify(navigation)} })
...
/*
  axios.get(`https://frugetbackend-production.up.railway.app/details/similiarbrand/${data}`)
  .then(res => dispatch({type:"similiarproductsbybrand",payload: res.data}))
  .catch(err => dispatch({type:"err",payload:err}))  

  axios.get(`https://frugetbackend-production.up.railway.app/details/product/${data}`)
...
export const submitsearcher =(data)=>{
  return (dispatch)=>{
     ...
     console.log(data)
  axios.get(`https://frugetbackend-production.up.railway.app/search/items/search?search=${data.search}&vendor=${data.vendor}&gun=${data.currentq}&sort=${data.sort}&max=${data.max}&min=${data.min}&brand=${data.brand}&inches=${data.inches}&litres=${data.litres}&colour=${data.colour}&page=${data.page}`)
  ...
  dispatch({type: 'loading'})
  axios.get(`https://frugetbackend-production.up.railway.app/search/items/searchbrand?search=${data.search}&max=${data.max}&min=${data.min}&brand=${data.brand !== undefined ?data.brand : null}&size=${data.size}&colour=${data.colour}`)
  .then(res=> dispatch({type: 'submitbrandsearched', payload: res.data}))
  .then(err => dispatch({type: 'error', payload: err}))

  dispatch({type: 'loading'})
  axios.get(`https://frugetbackend-production.up.railway.app/search/items/searchcolour?search=${data.search}&max=${data.max}&min=${data.min}&brand=${data.brand}&size=${data.size}&colour=${data.colour}`)
  .then(res=> dispatch({type: 'submitcolorsearched', payload: res.data}))
  .then(err => dispatch({type: 'error', payload: err}))

  dispatch({type: 'loading'})
  axios.get(`https://frugetbackend-production.up.railway.app/search/items/searchsize?search=${data.search}&max=${data.max}&min=${data.min}&brand=${data.brand}&selectedInches=${data.inches}&selectedLitres=${data.litres}&colour=${data.colour}`)
  ...
  dispatch({type: 'loading'})
  axios.get(`https://frugetbackend-production.up.railway.app/search/items/searchvendor?search=${data.search}&vendor=${data.vendor}`)
...
export const checkfilter = data =>{
  ...
  axios.get(`https://frugetbackend-production.up.railway.app/products/items/filter/${data.category}?page=${parseInt(data.page)}&sort=${data.sort}&max=${data.max}&min=${data.min}&vendor=${data.vendor}&brand=${data.brand}&litres=${data.litres}&inches=${data.inches}&colour=${data.colour}&q=${data.q}&rating=${data.rating}`)
...
export const checkvendorfilter = data =>{
  return (dispatch) =>{
  //dispatch({type: "filter"})
  axios.get(`https://frugetbackend-production.up.railway.app/products/goods/filter/${data.vendor}?page=${parseInt(data.page)}&sort=${data.sort}&max=${data.max}&min=${data.min}&vendor=${data.vendor}&brand=${data.brand}&litres=${data.litres}&inches=${data.inches}&colour=${data.colour}&q=${data.q}&rating=${data.rating}`)
...
export const getfilteredSuggestions = data =>{
  ...
  /*
  axios.get("https://frugetbackend-production.up.railway.app/suggestions/suggestion")
...
//,{ headers: {"Authorization" : `Bearer ${Cookies.get("token")} ${mainToken}`,"navigation":JSON.stringify(navigation)} }
 export const getProducts = data =>{
   return (dispatch)=>{
      dispatch({type: 'loading'})
    axios.get(`https://frugetbackend-production.up.railway.app/products/${data.category}?page=${parseInt(data.page)}&sort=${data.sort}&max=${data.max}&min=${data.min}&brand=${data.brand}&size=${data.size}&colour=${data.colour}&rating=${data.rating}`)
...
/*
   ...
   axios.get(`https://frugetbackend-production.up.railway.app/products/${data.category}/category?page=${data.page}`)
...
export const getvendorProducts = data =>{
  return (dispatch)=>{
     dispatch({type: 'loading'})
   axios.get(`https://frugetbackend-production.up.railway.app/products/goods/${data.vendor}?category=${data.category}&page=${parseInt(data.page)}&sort=${data.sort}&max=${data.max}&min=${data.min}&brand=${data.brand}&size=${data.size}&colour=${data.colour}&rating=${data.rating}`)
...
export const addtocart = data =>{
  return (dispatch) =>{
    dispatch({type:"loading"})
    axios.get(`https://frugetbackend-production.up.railway.app/customer/add-to-cart?id=${data.id}&color=${data.color}&inches=${data.inches}&litres=${data.litres}&wattage=${data.wattage}&kilogram=${data.kilogram}`,
    { headers: {"Authorization" : `Markaranter ${Cookies.get("token")}`,"markaranterTwo":mainToken,"navigation":JSON.stringify(navigation)} })
    .then(res =>{
      if(res.data.success){
...
export const clearcart =(data)=>{
  return(dispatch)=>{
    dispatch({type:"catloading"})
    axios.get(`https://frugetbackend-production.up.railway.app/customer/clear/cart?cartId=${data.cartId}&productId=${data.productId}&seller=${data.seller}&rating=${data.rating}&comment=${data.comment}`,{ headers: {"Authorization" : `Markaranter ${Cookies.get("token")}`,"markaranterTwo":mainToken,"navigation":JSON.stringify(navigation)} })
...
export const submitshoppingcart =()=>{
  return(dispatch)=>{
  dispatch({type:"loading"})
    axios.get(`https://frugetbackend-production.up.railway.app/customer/submit-to-cart`,{ headers: {"Authorization" : `Markaranter ${Cookies.get("token")}`,"markaranterTwo":mainToken,"navigation":JSON.stringify(navigation)} })
...
export const shoppingcart =(data)=>{
  return(dispatch)=>{
    dispatch({type:"loading"})
    axios.get(`https://frugetbackend-production.up.railway.app/customer/checkout?user=${data}`,{ headers: {"Authorization" : `Markaranter ${Cookies.get("token")}`,"markaranterTwo":mainToken,"navigation":JSON.stringify(navigation)} })
...
export const submittedcart =(data)=>{
  return(dispatch)=>{
    ...
    axios.get(`https://frugetbackend-production.up.railway.app/customer/submittedcart?user=${data}`,{ headers: {"Authorization" : `Markaranter ${Cookies.get("token")}`,"markaranterTwo":mainToken,"navigation":JSON.stringify(navigation)} })
...
export const fetchorders  =(data)=>{
  return(dispatch)=>{
    dispatch({type:"loading"})
    axios.get(`https://frugetbackend-production.up.railway.app/customer/orders?user=${data}`,{ headers: {"Authorization" : `Markaranter ${Cookies.get("token")}`,"markaranterTwo":mainToken,"navigation":JSON.stringify(navigation)} })
...
export const fetchinvoice  =(data)=>{
  return(dispatch)=>{
    ...
    axios.get(`https://frugetbackend-production.up.railway.app/customer/invoice?cartId=${data}`,{ headers: {"Authorization" : `Markaranter ${Cookies.get("token")}`,"markaranterTwo":mainToken,"navigation":JSON.stringify(navigation)} })
...
export const fetchgroupedcartbyinvoiceId =(data)=>{
  return(dispatch)=>{
    ...
    axios.get(`https://frugetbackend-production.up.railway.app/customer/group/submittedcart?email=${data}`,{ headers: {"Authorization" : `Markaranter ${Cookies.get("token")}`,"markaranterTwo":mainToken,"navigation":JSON.stringify(navigation)} })
...
export const fetchcartbyinvoiceId =(data)=>{
  return(dispatch)=>{
    ...
    axios.get(`https://frugetbackend-production.up.railway.app/customer/group/invoice?invoiceId=${data}`,{ headers: {"Authorization" : `Markaranter ${Cookies.get("token")}`,"markaranterTwo":mainToken,"navigation":JSON.stringify(navigation)} })
...
export const increaseshoppingcart =(data)=>{
  return(dispatch)=>{
    dispatch({type:"loading"})
    axios.get(`https://frugetbackend-production.up.railway.app/customer/increasecart?details=${data}`,{ headers: {"Authorization" : `Markaranter ${Cookies.get("token")}`,"markaranterTwo":mainToken,"navigation":JSON.stringify(navigation)} })
...
export const decreaseshoppingcart =(data)=>{
  return(dispatch)=>{
    dispatch({type:"loading"})
    axios.get(`https://frugetbackend-production.up.railway.app/customer/decreasecart?details=${data}`,{ headers: {"Authorization" : `Markaranter ${Cookies.get("token")}`,"markaranterTwo":mainToken,"navigation":JSON.stringify(navigation)} })
...
export const removeshoppingcart =(data)=>{
  return(dispatch)=>{
    dispatch({type:"loading"})
    axios.get(`https://frugetbackend-production.up.railway.app/customer/deletecart?details=${data}`,{ headers: {"Authorization" : `Markaranter ${Cookies.get("token")}`,"markaranterTwo":mainToken,"navigation":JSON.stringify(navigation)} })
...
export const allcategories = ()=>{
  return(dispatch)=>{
     dispatch({type:"catloading"})
    axios.get("https://frugetbackend-production.up.railway.app/products/products/allcategories")
...
export const allsubcategories = (data)=>{
  return(dispatch)=>{
     dispatch({type:"catloading"})
    axios.get(`https://frugetbackend-production.up.railway.app/products/${data}/category`)
...
export const allvendorsubcategories = (data)=>{
  return(dispatch)=>{
     dispatch({type:"loading"})
    axios.get(`https://frugetbackend-production.up.railway.app/products/vendor/${data}/category`)
...
export const getsidenav = data =>{
  return (dispatch)=>{
   dispatch({type: 'loading'})
   axios.get(`https://frugetbackend-production.up.railway.app/products/${data.category}/brand?selectedBrand=${data.brand}`)
   .then(res=> dispatch({type: 'brandloaded', payload: res.data}))
   .then(err => dispatch({type: 'error', payload: err}))

   axios.get(`https://frugetbackend-production.up.railway.app/products/${data.category}/color?selectedColour=${data.colour}`)
   .then(res=> dispatch({type: 'colorloaded', payload: res.data}))
   .then(err => dispatch({type: 'error', payload: err}))

   axios.get(`https://frugetbackend-production.up.railway.app/products/${data.category}/size?selectedInches=${data.inches}&selectedLitres=${data.litres}`)
   ...
   axios.get(`https://frugetbackend-production.up.railway.app/products/${data.category}/seller?selectedseller=${data.vendor}`)
   .then(res=> dispatch({type:'sellerbycategory', payload: res.data}))
   .then(err => dispatch({type: 'error', payload: err}))
  
   dispatch({type: 'priceloading'})
   axios.get(`https://frugetbackend-production.up.railway.app/products/${data.category}/price`)
...
export const getvendorsidenav = data =>{
  return (dispatch)=>{
   dispatch({type: 'loading'})
   axios.get(`https://frugetbackend-production.up.railway.app/products/goods/${data.vendor}/brand?selectedBrand=${data.brand}`)
   .then(res=> {dispatch({type: 'vendorbrandloaded', payload: res.data})
   dispatch({type:"unloading"})})
   .then(err => dispatch({type: 'error', payload: err}))

   dispatch({type: 'loading'})
   axios.get(`https://frugetbackend-production.up.railway.app/products/goods/${data.vendor}/color?selectedColour=${data.colour}`)
   .then(res=> {dispatch({type: 'vendorcolorloaded', payload: res.data})
   dispatch({type:"unloading"})})
   .then(err => dispatch({type: 'error', payload: err}))

   dispatch({type: 'loading'})
   axios.get(`https://frugetbackend-production.up.railway.app/products/goods/${data.vendor}/size?selectedInches=${data.inches}&selectedLitres=${data.litres}`)
...
export const sendmessage = data =>{
  return (dispatch)=>{
   dispatch({type: 'loading'})
   axios.post(`https://frugetbackend-production.up.railway.app/search/connection/chat/message`,{data:JSON.stringify(data)},{ headers: {"Authorization" : `Markaranter ${Cookies.get("token")}`,"markaranterTwo":mainToken,"navigation":JSON.stringify(navigation)} })
...
export const fetchmessage = data =>{
  return (dispatch)=>{
   dispatch({type: 'loading'})
   axios.get(`https://frugetbackend-production.up.railway.app/search/fetch/chat/message?otheruserId=${data.otheruserId}`,{ headers: {"Authorization" : `Markaranter ${Cookies.get("token")}`,"markaranterTwo":mainToken,"navigation":JSON.stringify(navigation)} })
...
export const fetchconnections = data =>{
 ...
 //  dispatch({type: 'loading'})viewsender
   axios.get(`https://frugetbackend-production.up.railway.app/search/fetch/connected/clients?userId=${data}`,{ headers: {"Authorization" : `Markaranter ${Cookies.get("token")}`,"markaranterTwo":mainToken,"navigation":JSON.stringify(navigation)} })
