...
class SearchApp extends Component {
 ...
 axios.get(`https://frugetbackend-production.up.railway.app/search/category/searched/price?search=${data.search}&brand=${data.brand}&size=${data.size}&colour=${data.colour}`)
